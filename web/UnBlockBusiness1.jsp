...
<%
    ...
    {            
        bid = Integer.parseInt(request.getParameter("bid"));        
                ...
                String qry = "Update businesstb Set Status='Open'  where BussId="+bid;
                ...
                out.print("Business unblocked successfully.....");
    ...
    if(request.getParameter("bid")!=null)
    {
        ...
        <form action="UnBlockBusiness1.jsp" method="get">
        ...
        <table align="center" cellpadding="20">
            ...
            <td colspan=2 align=center><input type="submit" value="Unblock" name="Unblock"/></td>
            </tr>
