...
<%
    ...
    unm = session.getAttribute("unm").toString();
                ...
                String qry = "select * from businesstb where Username='"+unm+"'";
                ...
                while(Rs.next())
                {
                    ...
                    <tr align=center >
                        <td style="padding:15px;"> <a href="UpdateBusiness1.jsp?bid=<% out.print(Rs.getString("BussId"));  %>" style="color:Black;" >Edit</a> </td>
